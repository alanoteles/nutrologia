...
<html <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		<div id="page" class="site">
			<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'nutrologia' ); ?></a>
					...
					<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
						<div class="container">
							<div class="navbar-header">
								...
								<!-- <a class="navbar-brand" href="/."><img src="<?php //bloginfo('stylesheet_directory');  ?>/assets/img/logo.png" alt="Bootstrap to Worpress"></a>	 -->					
							</div><!-- navbar-header -->
